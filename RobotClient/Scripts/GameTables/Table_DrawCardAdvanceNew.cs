...
[Serializable]
 public class Tab_DrawCardAdvanceNew
{ private const string TAB_FILE_DATA = "table/DrawCardAdvanceNew.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
public static bool LoadTable(Dictionary<int, List<Tab_DrawCardAdvanceNew> > _tab)
 {
 ...
 public static Tab_DrawCardAdvanceNew SerializableTable(string[] valuesList,int skey)
 {
 if ((int)_ID.MAX_RECORD!=valuesList.Length)
 {
 throw TableException.ErrorReader("Load {0} error as CodeSize:{1} not Equal DataSize:{2}", GetInstanceFile(),_ID.MAX_RECORD,valuesList.Length);
 }
 Tab_DrawCardAdvanceNew _values = new Tab_DrawCardAdvanceNew();
