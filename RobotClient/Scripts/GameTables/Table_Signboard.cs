...
[Serializable]
 public class Tab_Signboard
{ private const string TAB_FILE_DATA = "Table/Signboard.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
private int m_Theme;
 public int Theme { get{ return m_Theme;}}

public static bool LoadTable(Dictionary<int, List<Tab_Signboard> > _tab)
 {
 ...
 public static Tab_Signboard SerializableTable(string[] valuesList,int skey)
 {
 if ((int)_ID.MAX_RECORD!=valuesList.Length)
 {
 throw TableException.ErrorReader("Load {0} error as CodeSize:{1} not Equal DataSize:{2}", GetInstanceFile(),_ID.MAX_RECORD,valuesList.Length);
 }
 Tab_Signboard _values = new Tab_Signboard();
...
_values.m_Theme =  TableManager.ConvertToInt32(valuesList[(int)_ID.ID_THEME] as string);
