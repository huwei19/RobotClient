...
{ private const string TAB_FILE_DATA = "Table/StrDictionary.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
public static bool LoadTable(Dictionary<int, List<Tab_StrDictionary> > _tab)
 {
 ...
 public static Tab_StrDictionary SerializableTable(string[] valuesList,int skey)
 {
