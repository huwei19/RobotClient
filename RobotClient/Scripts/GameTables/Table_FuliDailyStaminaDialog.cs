...
[Serializable]
 public class Tab_FuliDailyStaminaDialog
{ private const string TAB_FILE_DATA = "Table/FuliDailyStaminaDialog.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
public static bool LoadTable(Dictionary<int, List<Tab_FuliDailyStaminaDialog> > _tab)
 {
 ...
 public static Tab_FuliDailyStaminaDialog SerializableTable(string[] valuesList,int skey)
 {
 if ((int)_ID.MAX_RECORD!=valuesList.Length)
 {
 throw TableException.ErrorReader("Load {0} error as CodeSize:{1} not Equal DataSize:{2}", GetInstanceFile(),_ID.MAX_RECORD,valuesList.Length);
 }
 Tab_FuliDailyStaminaDialog _values = new Tab_FuliDailyStaminaDialog();
