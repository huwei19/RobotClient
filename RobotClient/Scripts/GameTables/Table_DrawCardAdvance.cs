...
[Serializable]
 public class Tab_DrawCardAdvance
{ private const string TAB_FILE_DATA = "table/DrawCardAdvance.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
public static bool LoadTable(Dictionary<int, List<Tab_DrawCardAdvance> > _tab)
 {
 ...
 public static Tab_DrawCardAdvance SerializableTable(string[] valuesList,int skey)
 {
 if ((int)_ID.MAX_RECORD!=valuesList.Length)
 {
 throw TableException.ErrorReader("Load {0} error as CodeSize:{1} not Equal DataSize:{2}", GetInstanceFile(),_ID.MAX_RECORD,valuesList.Length);
 }
 Tab_DrawCardAdvance _values = new Tab_DrawCardAdvance();
