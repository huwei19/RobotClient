...
public class GameDefines
{
	public static OutputVersionDefs OutputVerDefs{
		get{
			...
			else
			{
				...
				Debug.Log("Current sdkPlatform is " + sdkPlatform);
    ...
    public static string PublicResVersionKey = "0";
    ...
    public static string GMCMD_BEGINORDER = "tlol";
    public static int MAX_TRY_CONNECT = 1;
    public const float CONNECT_TIMEOUT = 15.0f;         // 等待超时时间，超过时间可继续发包
